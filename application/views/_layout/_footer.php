<!-- END CONTENT -->
        ...
        <script src="<?= base_url()?>assets/jQuery/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script>
        <script src="<?= base_url()?>assets/bootstrap/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        <script src="<?= base_url()?>assets/js/scripts.js"></script>
        <script src="<?= base_url()?>assets/https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        ...
        <script src="<?= base_url()?>assets/https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
