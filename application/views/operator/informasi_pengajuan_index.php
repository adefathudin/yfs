                        ...
                        },
                        {
                            ...
                            action: function(e, dt, btn, config){
                                ...
                                detail +=
                                        ...
                                        '<tr><td>Nama Pemohon</td><td>:</td><td>'+$item.nama_lengkap+'</td></tr>' +
                                        '<tr><td>Tanggal Pengajuan</td><td>:</td><td>'+$item.add_time+'</td></tr>' +
                                        '<tr><td>Status Pengajuan</td><td>:</td><td>'+$item.desc_status+'. '+$item.operator_note+$item.ka_ukpd_note+'</td></tr>';
                                ...
                                $.ajax({
                                    ...
                                    var i;
                                    if (data.status) {
                                        detail += '<tr><td>Persyaratan</td><td>:</td><td>';
                                        //file pendukung
                                        for (i=0;i<data.fp_eksist.length;i++){
                                             detail += 
                                                     '<div class="form-check">' +
                                                        '<input class="form-check-input checkbox-fp" name="checkbox_fp[]" type="checkbox" value="'+data.fp_eksist[i].id+'" id="fp'+data.fp_eksist[i].id+'" checked disabled="disabled">'+
                                                        '<label class="form-check-label" for=""fp'+data.fp_eksist[i].id+'"">'+
                                                          '<a href="#" data-fp="'+data.fp_eksist[i].path_upload+'" data-fp-name="'+data.fp_eksist[i].desc_fp+'" data-fp-date="'+data.fp_eksist[i].upload_time+'"  class="show-image">'+data.fp_eksist[i].desc_fp+'</a>'+
                                                        '</label>'+
                                                      '</div>';
                                        }
                                        detail += '</td></tr>';
